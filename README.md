...
Se incluye como demostración de:
...
GitHub Projects (Kanban) → Gestión visual del ciclo de pruebas

GitHub Milestones → Control del avance

GitHub Actions → Automatización de pruebas (simulada)
